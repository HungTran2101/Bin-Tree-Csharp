...
namespace DoAnCK_BinTree
{
    class Tree_Node
    {
        ...
        public async void timKiem(Tree_Node tree, int data, Form1 form1)
        {
        ...
        public void PreOrderS(Tree_Node tree, Form1 form1, int delay)
        {
            if (tree != null)
            {
                TaoKhungNode(tree, Color.Green, form1);
        ...
        public void PostOrderS(Tree_Node tree, Form1 form1, int delay)
        {
            if (tree != null)
            {
        ...
        public void InOrderS(Tree_Node tree, Form1 form1, int delay)
        {
            if (tree != null)
            {
        ...
        private void TaoKhungNode(Tree_Node tmp, Color color, Form1 form1)
        {
            ...
            //Label lbl = new Label();
            //lbl.Location = new System.Drawing.Point(tmp.ToaDoX - 5, tmp.ToaDoY - 5);
            //lbl.BackColor = color;
            ...
            //lbl.Size = new System.Drawing.Size(form1.NodeSize + 10, form1.NodeSize + 10);
            //return lbl;
        }
    }
}
