...
namespace DoAnCK_BinTree
{
    public partial class Form1 : Form
    {
        ...
        Binary_Tree Btree = new Binary_Tree(); //tạo cây mới
        ...
        {
            InitializeComponent();
            info += "--------=====||_Binary_Tree_Demo_Project_||=====--------";
            info += "\n\n CODE BY:";
            info += "\n - Trần Nhật Hùng - 19110213";
            info += "\n - Nguyễn Hoàng Phúc - 19110268";
            info += "\n\n Tham khao: www.rebvn.com ( cây nhị phân tìm kiếm trong C# )";
        ...
        private void AddBt_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Only input number!", "ERROR", MessageBoxButtons.OK,MessageBoxIcon.Error);
            }
